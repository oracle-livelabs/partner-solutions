...
Before you get started with the development of labs and workshop, check out the **Introduction to Oracle GitHub Project and oracle-livelabs Repositories** and **Introduction to LiveLabs Workshop Workflow** labs to know about:
